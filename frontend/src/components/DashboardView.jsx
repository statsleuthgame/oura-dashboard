...
import HrvReadinessPanel from "./HrvReadinessPanel";
import ActivityPanel from "./ActivityPanel";
import CorrelationsPanel from "./CorrelationsPanel";
import AppleHeartPanel from "./AppleHeartPanel";
import AppleActivityPanel from "./AppleActivityPanel";
import AppleSleepPanel from "./AppleSleepPanel";
import AppleWorkoutsPanel from "./AppleWorkoutsPanel";
import AppleVitalsPanel from "./AppleVitalsPanel";
